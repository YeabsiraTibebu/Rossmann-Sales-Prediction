...
# rossmann_sales_prediction documentation build
...
from rossmann_sales_prediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "rossmann_sales_prediction"
author = "Kedro"
...
htmlhelp_basename = "rossmann_sales_predictiondoc"
...
latex_documents = [
    (
        master_doc,
        "rossmann_sales_prediction.tex",
        "rossmann_sales_prediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "rossmann_sales_prediction",
        "Project rossmann_sales_prediction codebase.",
        "Data-Science",
    )
]
